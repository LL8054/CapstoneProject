...
```{r}
system.time(NextWordPredictor("Very early observations on the Bills game: Offense still struggling but the", 3, " "))
```
...
```{r}
NextWordPredictor("After the ice bucket challenge Louis will push his long wet hair out of his eyes with his little", 2, " ")
```
...
```{r}
NextWordPredictor("Be grateful for the good times and keep the faith during the", 2, " ")
```
